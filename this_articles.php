...
<a href="/<?php echo $row_this['AID'] ?>" style="text-decoration: none;color:inherit;display: contents;">
        <div class="this-article-block">
                <div class="this-article-block-inner">
                        ...
                        <p class="mobilesmall" style="font-size: .9em;opacity:60%;display:inline-block;color:red;text-transform:uppercase;height:70px;"><?php echo date('F j',  strtotime($row_this['ADate']))  ?></p>
